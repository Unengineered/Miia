...
const store_repository_1 = __importDefault(require("./store/infrastructure/store_repository"));
...
const store_repo = new store_repository_1.default({
    mongoDbConnection: mongoose_1.default.createConnection((_b = process.env.MONGO_REMOTE_URI) !== null && _b !== void 0 ? _b : ""),
});
...
function func() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        store_repo.putStoreLink(new store_link_1.StoreLinkEntity({
            id: null,
            ...
            .then((response) => store_repo.putStoreLink(new store_link_1.StoreLinkEntity({
            id: null,
            name: '_yellow.petals',
...
(() => {
    var _a;
    var m = mongoose_1.default.createConnection((_a = process.env.MONGO_REMOTE_URI) !== null && _a !== void 0 ? _a : "").model('StoreLink', store_link_1.StoreLinkSchema);
    var result = [];
    var myMap = new Map();
    m.find()
        .then((response) => {
